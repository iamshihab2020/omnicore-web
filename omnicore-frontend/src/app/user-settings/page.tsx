              ...
              <div className="flex flex-col md:flex-row gap-8">
                <div className="md:w-1/3">
                  <div className="flex flex-col items-center">
                    <div className="h-32 w-32 rounded-full overflow-hidden border-4 border-gray-200 dark:border-gray-700">
                      {currentUser?.photoURL ? (
                        ...
                        <div className="h-full w-full flex items-center justify-center bg-gray-100 dark:bg-gray-700 text-4xl font-bold text-gray-500 dark:text-gray-400">
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <div className="mt-8 border-t border-gray-200 dark:border-gray-700 pt-6">
                        ...
                        <AccountLinking
                          onSuccess={() => {
                            // Force a refresh of the user interface
