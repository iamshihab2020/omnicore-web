  ...
  return (
    <Card className="rounded-xl">
      <aside className="w-full md:w-80 max-w-full md:max-w-xs lg:max-w-sm flex-shrink-0 text-card-foreground p-0 flex flex-col min-h-[500px]">
        <div className="px-4 sm:px-6 py-4 border-b border-border flex items-center justify-between bg-muted rounded-2xl">
          ...
          {cart.length === 0 ? (
            ...
            <ul className="space-y-3">
              {cart.map((item) => (
                <li
                  key={item.id}
                  className="flex items-center gap-3 bg-sidebar-accent rounded-lg px-3 py-2 group"
                >
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="text-xs text-muted-foreground flex items-center gap-2">
                      ...
                      <span>
                        Quantity:{"  "}
                        <Badge variant={'destructive'} className="rounded-full font-semibold">{item.quantity}</Badge>
                      </span>
                    </div>
                  </div>
        ...
        <div className="px-4 sm:px-6 py-4 border-t border-border bg-muted rounded-2xl">
