...
from .models import Category, MenuItem, MenuItemVariant, MenuItemAddon, MenuItemAddonGroup, MenuItemAddonGroupItem
...
class MenuItemAddonGroupItemSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'addon', 'addon_id', 'display_order'
        ]
        read_only_fields = ['id']
...
class MenuItemSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'price', 'cost', 'image', 'is_active', 'is_featured',
            'is_vegetarian', 'is_vegan', 'is_gluten_free', 'preparation_time',
            'calories', 'display_order', 'variants', 'created_at', 'updated_at'
        ]
        read_only_fields = ['id', 'created_at', 'updated_at']
