...
class CounterViewSet(viewsets.ModelViewSet):
    ...
    permission_classes = [permissions.IsAuthenticated, IsTenantUser]    def get_queryset(self):
        """
    ...
    def create(self, request, *args, **kwargs):
        ...
        if hasattr(request, 'tenant') and Counter.objects.filter(tenant=request.tenant, name=counter_name).exists():
            return Response(
