  ...
  return (
    <div className="flex min-h-screen">
      ...
      <motion.div
        ...
        className="hidden md:flex md:w-1/2 bg-gradient-to-br from-primary/80 to-primary flex-col justify-center items-center text-primary-foreground p-8 relative overflow-hidden"
      >
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          ...
          >
            <p className="text-sm text-primary-foreground/70">
              Start managing your business efficiently with our powerful
              platform designed for growth and productivity.
            </p>
          </motion.div>
        </motion.div>
      </motion.div>
